...
if ( !class_exists( 'Sunrise6' ) ) {
	...
	class Sunrise6 {
		...
		public function assets() {
			// Register styles
			wp_register_style(  'sunrise-' . $this->config['version'], plugins_url( $this->config['css'], $this->config['file'] ) . '/assets/sunrise.css', false, $this->config['version'], 'all' );
			// Register scripts
			wp_register_script( 'sunrise-' . $this->config['version'], plugins_url( $this->config['js'],  $this->config['file'] ) . '/assets/sunrise.js', array( 'jquery', 'jquery-form' ), $this->config['version'], true );
			// Add some l10n to JS
